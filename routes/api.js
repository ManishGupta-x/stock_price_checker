...
module.exports = function (app) {
  let uri =
    "mongodb+srv://Manish:m7827851250@pesmobile.zolll.mongodb.net/stock_prices?retryWrites=true&w=majority";
  ...
  app.route("/api/stock-prices").get(function (req, res) {
    ...
    const findOrUpdateStock = async (stockName, documentUpdate, nextStep) => {
      try {
